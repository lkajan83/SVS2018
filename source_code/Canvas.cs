...
namespace DXFImporter
{
	...
	public class Canvas : System.Windows.Forms.Form
	{
        ...
        private ToolStripMenuItem converToPDFToolStripMenuItem;
		...
		private void InitializeComponent()
		{
            ...
            this.converToPDFToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.converToPDFToolStripMenuItem});
            ...
            // 
            // converToPDFToolStripMenuItem
            // 
            this.converToPDFToolStripMenuItem.Name = "converToPDFToolStripMenuItem";
            this.converToPDFToolStripMenuItem.Size = new System.Drawing.Size(97, 20);
            this.converToPDFToolStripMenuItem.Text = "Conver To PDF";
            this.converToPDFToolStripMenuItem.Click += new System.EventHandler(this.converToPDFToolStripMenuItem_Click);
            // 
            // Canvas
            // 
        ...
        private void converToPDFToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DialogResult = MessageBox.Show("Welcome to Conditional MessageBox  \n Please select one option Yes / No)",   "Conditional", MessageBoxButtons.YesNo,  MessageBoxIcon.Information);
            if (DialogResult == DialogResult.Yes)
            {
                ...
                //    MessageBox.Show("Convert Succefully.....");
                //}
            ...
            {
                MessageBox.Show("not Convert Succefully.....");
            }
        }
